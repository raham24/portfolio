...
export const ContributionGraphBlock = ({
  ...
  return (
    <rect
      className={cn(
        'data-[level="0"]:fill-zinc-800',
        'data-[level="1"]:fill-green-900',
        'data-[level="2"]:fill-green-700',
        'data-[level="3"]:fill-green-500',
        'data-[level="4"]:fill-green-400',
        className
      )}
  ...
  return (
    ...
    >
      ...
      >
        ...
        {!hideMonthLabels && (
          <g className="fill-zinc-400 text-xs">
...
export const ContributionGraphFooter = ({
  ...
  <div
    className={cn(
      "flex flex-wrap gap-1 whitespace-nowrap sm:gap-x-4 text-zinc-400",
      className
    )}
    {...props}
  />
...
export const ContributionGraphLegend = ({
  ...
  return (
    <div
      ...
      {...props}
    >
      <span className="mr-1 text-zinc-400 text-xs">
